...
public class AplicacaoObjeto {

	public void retirarCaroco(Fruta fruta){
	...
	public void retirarCasca(Fruta fruta){
		if (fruta.getCasca()){
	...
	public static void main(String[] args) {
		...
		AplicacaoObjeto app = new AplicacaoObjeto();
		app.comerFruta(f2);
		Aplicacao.comerFruta(f2);
	}
}
